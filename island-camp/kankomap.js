...
const FERRIES = {
  ...
  'toshima':      [ {lat:34.529,  lng:139.279,  ang:-95,  len:12, label:'竹芝へ'} ],
  'shikinejima':  [ {lat:34.3352, lng:139.2137, ang:-60,  len:12, label:'竹芝へ'} ],
  'miyakejima':   [ {lat:34.100,  lng:139.5555, ang:-55,  len:13, label:'竹芝へ'} ],
  'mikurajima':   [ {lat:33.8957, lng:139.5893, ang:-95,  len:12, label:'三宅島・竹芝へ'} ],
  'aogashima':    [ {lat:32.448,  lng:139.755,  ang:-155, len:11, label:'八丈島へ'} ],
  'kikaijima':    [ {lat:28.318,  lng:129.932,  ang:-170, len:12, label:'鹿児島・奄美へ'} ],
  'tokunoshima':  [ {lat:27.734,  lng:129.024,  ang:-10,  len:12, label:'鹿児島・那覇へ'} ],
  'okinoerabu':   [ {lat:27.393,  lng:128.657,  ang:-30,  len:12, label:'鹿児島・那覇へ'} ],
  'yoron':        [ {lat:27.034,  lng:128.4035, ang:170,  len:11, label:'鹿児島・那覇へ'} ],
  'okinawa-hontou':[ {lat:26.216, lng:127.672,  ang:180,  len:13, label:'鹿児島へ'} ],
  'kumejima':     [ {lat:26.342,  lng:126.739,  ang:150,  len:11, label:'那覇へ'} ],
  'miyako':       [ {lat:24.810,  lng:125.282,  ang:-170, len:11, label:'多良間へ'} ],
  'tanegashima':  [ {lat:30.7281, lng:130.9926, ang:-120, len:13, label:'鹿児島へ'} ],
  'yonaguni':     [ {lat:24.451,  lng:122.943,  ang:-60,  len:11, label:'石垣へ'} ],
  'hateruma':     [ {lat:24.068,  lng:123.771,  ang:-120, len:11, label:'石垣へ'} ],
