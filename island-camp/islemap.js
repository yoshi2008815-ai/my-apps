...
const POI = {
  ...
  'toshima':      { peak:{name:'宮塚山', ele:508,  lat:34.516, lng:139.282}, port:{name:'利島港',   lat:34.529, lng:139.279} },
  'niijima':      { peak:{name:'宮塚山', ele:432,  lat:34.418, lng:139.259}, port:{name:'新島港',   lat:34.372, lng:139.252} },
  'shikinejima':  { peak:{name:'神引山', ele:99,   lat:34.326, lng:139.199}, port:{name:'野伏港',   lat:34.332, lng:139.202} },
  'kozushima':    { peak:{name:'天上山', ele:572,  lat:34.219, lng:139.156}, port:{name:'神津島港', lat:34.203, lng:139.134} },
  'mikurajima':   { peak:{name:'御山',   ele:851,  lat:33.874, lng:139.603}, port:{name:'御蔵島港', lat:33.898, lng:139.594} },
  'hachijojima':  { peak:{name:'八丈富士', ele:854, lat:33.136, lng:139.762}, port:{name:'底土港',  lat:33.113, lng:139.802} },
  'aogashima':    { peak:{name:'大凸部', ele:423,  lat:32.462, lng:139.766}, port:{name:'三宝港',   lat:32.448, lng:139.755} },
  ...
  'tanegashima':  { port:{name:'西之表港', lat:30.732, lng:130.996} },
  'amami-oshima': { peak:{name:'湯湾岳', ele:694,  lat:28.294, lng:129.325}, port:{name:'名瀬港',   lat:28.383, lng:129.493} },
  'kikaijima':    { peak:{name:'百之台', ele:203,  lat:28.298, lng:129.966}, port:{name:'湾港',     lat:28.318, lng:129.932} },
  'tokunoshima':  { peak:{name:'井之川岳', ele:645, lat:27.755, lng:128.963}, port:{name:'亀徳港',  lat:27.727, lng:129.027} },
  'okinoerabu':   { peak:{name:'大山',   ele:240,  lat:27.359, lng:128.587}, port:{name:'和泊港',   lat:27.393, lng:128.657} },
  'yoron':        { port:{name:'与論港', lat:27.011, lng:128.398} },
  'okinawa-hontou':{ peak:{name:'与那覇岳', ele:503, lat:26.717, lng:128.216}, port:{name:'那覇港', lat:26.216, lng:127.672} },
  'kumejima':     { peak:{name:'宇江城岳', ele:310, lat:26.363, lng:126.783}, port:{name:'兼城港',  lat:26.340, lng:126.766} },
  'miyako':       { port:{name:'平良港', lat:24.810, lng:125.282} },
  'ishigaki':     { peak:{name:'於茂登岳', ele:526, lat:24.422, lng:124.190}, port:{name:'石垣港',  lat:24.334, lng:124.156} },
  'iriomote':     { peak:{name:'古見岳', ele:469,  lat:24.348, lng:123.898}, port:{name:'大原港',   lat:24.284, lng:123.876} },
  'yonaguni':     { peak:{name:'宇良部岳', ele:231, lat:24.455, lng:123.023}, port:{name:'久部良港', lat:24.451, lng:122.943} },
